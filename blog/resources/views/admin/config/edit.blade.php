            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>类型：</th>
                        <td>
                            <input type="radio" name="field_type" @if($field->field_type=='input') checked @endif value="input" onclick="showTr()"/>input &nbsp;
                            <input type="radio" name="field_type" @if($field->field_type=='textarea') checked @endif value="textarea" onclick="showTr()"/>textarea&nbsp;
                            <input type="radio" name="field_type" @if($field->field_type=='radio') checked @endif value="radio" onclick="showTr()"/>radio&nbsp;
                        </td>
                    </tr>
                    <tr class="field_value">
                        ...
                        <td>
                            ...
                            <p><i class="fa fa-exclamation-circle yellow"></i>类型值只有在radio的情况下才需要配置，格式 1|开始，0|关闭</p>
                        </td>
                    </tr>
                    <tr>
                        <th>排序：</th>
